...
- [API Documentation](#api-documentation)
  ...
  - [`bool User::updateReceiveEventEmails(const QString& userId, bool receive) `](#bool-userupdatereceiveeventemailsconst-qstring-userid-bool-receive-)
  ...
  - [`QSqlQuery query(db)`](#qsqlquery-querydb-22)
